...
\newcommand\FortressOuterKWD[1]{{\ensuremath{\mathtt{#1}\FortressMathsurround}}}
\newcommand\FortressOuterKWDVAR[1]{{\ensuremath{\mathtt{#1}\FortressMathsurround}}}
\newcommand\FortressOuterOPR[1]{{\ensuremath{\mathtt{#1}\FortressMathsurround}}}
\newcommand\FortressOuterTYP[1]{{\ensuremath{\mathrm{#1}\SmallFortressMathsurround}}}
\newcommand\FortressOuterVAR[1]{{\ensuremath{\mathit{#1}\SmallFortressMathsurround}}}
\newcommand\FortressOuterSTR[1]{{\ensuremath{\hbox{\tt#1}\FortressMathsurround}}}
\newcommand\EXP[1]{{\ensuremath{{\protect\FortressInnerMacros#1}\FortressMathsurround}}}
\newcommand\FortressOuterMacros{\let\KWD\FortressOuterKWD \let\KWDVAR\FortressOuterKWDVAR \let\OPR\FortressOuterOPR
 \let\TYP\FortressOuterTYP \let\VAR\FortressOuterVAR \let\STR\FortressOuterSTR}
...
\newcommand\FortressInnerSTR[1]{\hbox{\tt#1}}
\newcommand\FortressInnerMacros{\let\KWD\FortressInnerKWD \let\KWDVAR\FortressInnerKWDVAR \let\OPR\FortressInnerOPR
  \let\BIGOPR\FortressInnerBIGOPR \let\BIGOP\FortressInnerBIGOP
...
\newif\iffortresspng  \fortresspngtrue


\newcommand\FortressCode{\lineskip 0pt
  ...
  \fortressbeginline\ignorespaces}
\def\endFortressCode{\fortressendline
...
\newcommand\fortressbeginline{\fortressretrievenewindent
  ...
  \setbox\fortresscodeline=\hbox{\iffortresspng\hbox to 0pt{\color{white}\vrule height 0.001pt width 0.001pt\hss}\fi
...
\newcommand\fortressblockcomment[2]{\fortresscancelline
  \begingroup\setbox\fortresscommentbox=\vbox\bgroup
  ...
  \def\topcommentline{\fortresscommentline{\rightskip}{0pt}{0pt}\fortresstopcommentlinetrue\endgroup\par}\relax
  \def\bottomcommentline{\ifhmode\endgroup\par\fi\begingroup\leavevmode
    \fortresscommentline{\leftskip}{0pt}{0pt}\fortressbottomcommentlinetrue}\relax
  \def\toprightcommentline{\fortresscommentline{\rightskip}{0pt}{\fortresscommentrulemargin}\fortresstopcommentlinetrue\endgroup\par}\relax
  \def\bottomleftcommentline{\ifhmode\endgroup\par\fi\begingroup\leavevmode
...
\newcommand\fortressitem[1]{\fortressleftindent{#1}%
  \hbox to 0pt{\hss\csname fortressitem\romannumeral#1\endcsname$\mskip 7mu$}\ignorespaces}
...
\newcommand\fortressenum[2]{\fortressleftindent{#1}%
  \hbox to 0pt{\hss\csname fortressenum\romannumeral#1\endcsname{#2}$\mskip 7mu$}\ignorespaces}
...
\newcommand\fortressdesc[3]{\par\begingroup
  \advance\leftskip by #1\fortressleftindentincrement
  \advance\leftskip by #3\fortressleftindentincrement
  \setbox\fortresstempbox=\hbox{\hskip-\fortressleftindentincrement
                                \hskip-#3\fortressleftindentincrement
                               #2$\;$}\relax
