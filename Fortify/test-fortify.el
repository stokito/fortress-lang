...
(defun test-group-fortress-render-operator-word ()
  (test-fortress-test-group-funcall
   ...
   '(((OPERATOR-WORD "FOO" "\\OPR{FOO}"))
     ...
     ((BIGOP "SUM" "\\sum"))
     ((BIGOP "PROD" "\\prod"))
     ((OPERATOR-WORD "PREFIX_CAP" "\\mathbin{\\overrightarrow{\\cap}}"))
     ((OPERATOR-WORD "SUFFIX_CUP" "\\mathbin{\\overleftarrow{\\cup}}"))
     ((OPERATOR-WORD "PREFIX_OPLUS" "\\mathbin{\\overrightarrow{\\oplus}}"))
     ((OPERATOR-WORD "SUFFIX_OTIMES" "\\mathbin{\\overleftarrow{\\otimes}}"))
     ((OPERATOR-WORD "PREFIX_MAX" "\\mathbin{\\overrightarrow{\\OPR{MAX}}}"))
     ((OPERATOR-WORD "SUFFIX_MIN" "\\mathbin{\\overleftarrow{\\OPR{MIN}}}"))
