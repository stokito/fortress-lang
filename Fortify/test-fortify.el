...
(defun test-group-fortress-render-single-comment ()
  (test-fortress-test-group-funcall
   ...
   '(((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}"))
     ((COMMENT "(*BAZOLA*)" "\\hbox{\\tt(*}\\hbox{BAZOLA}\\hbox{\\tt*)}"))
     ((COMMENT "(* {}#$'%''& *)" "\\hbox{\\tt(*}\\hbox{ \\{\\}\\#\\$'\\%{'}'\\& }\\hbox{\\tt*)}"))
     ((COMMENT "(* \\ *)" "\\hbox{\\tt(*}\\hbox{ {\\tt\\char'134} }\\hbox{\\tt*)}"))
     ((COMMENT "(* ^ *)" "\\hbox{\\tt(*}\\hbox{ {\\char'136} }\\hbox{\\tt*)}"))
     ((COMMENT "(* ~ *)" "\\hbox{\\tt(*}\\hbox{ ~}\\hbox{\\tt*)}"))
     ((COMMENT "(* _ *)" "\\hbox{\\tt(*}\\hbox{ \\_ }\\hbox{\\tt*)}"))
     ((COMMENT "(* \u222A *)" "\\hbox{\\tt(*}\\hbox{ \\(\\cup\\) }\\hbox{\\tt*)}"))
     ((COMMENT "(* **Foo** *)" "\\hbox{\\tt(*}\\hbox{ {\\bf{Foo}} }\\hbox{\\tt*)}"))
     ((COMMENT "(* //Foo// *)" "\\hbox{\\tt(*}\\hbox{ \\emph{Foo} }\\hbox{\\tt*)}"))
     ((COMMENT "(* ##Foo## *)" "\\hbox{\\tt(*}\\hbox{ {\\tt{Foo}} }\\hbox{\\tt*)}"))
     ((COMMENT "(* \"Foo\" *)" "\\hbox{\\tt(*}\\hbox{ {``}Foo{''} }\\hbox{\\tt*)}"))
     ((COMMENT "(* ##\"Foo\"## *)" "\\hbox{\\tt(*}\\hbox{ {\\tt{{\\char'42}Foo{\\char'42}}} }\\hbox{\\tt*)}"))
     ((COMMENT "(* **//Foo//** *)" "\\hbox{\\tt(*}\\hbox{ {\\bf{{\\bf\\emph{Foo}}}} }\\hbox{\\tt*)}"))
     ((COMMENT "(* //**Foo**// *)" "\\hbox{\\tt(*}\\hbox{ \\emph{{\\bf\\emph{Foo}}} }\\hbox{\\tt*)}"))
     ((COMMENT "(* **Foo //is// phoo** *)" "\\hbox{\\tt(*}\\hbox{ {\\bf{Foo {\\bf\\emph{is}} phoo}} }\\hbox{\\tt*)}"))
     ((COMMENT "(* //Foo **is** phoo// *)" "\\hbox{\\tt(*}\\hbox{ \\emph{Foo {\\bf\\emph{is}} phoo} }\\hbox{\\tt*)}"))
     ((COMMENT "(* **Foo ##is## phoo** *)" "\\hbox{\\tt(*}\\hbox{ {\\bf{Foo {\\tt{is}} phoo}} }\\hbox{\\tt*)}"))
     ((COMMENT "(*##Foo##*)" "\\hbox{\\tt(*}\\hbox{{\\tt{Foo}}}\\hbox{\\tt*)}"))
     ((COMMENT "(**##Foo##**)" "\\hbox{\\tt(**}\\hbox{{\\tt{Foo}}}\\hbox{\\tt**)}"))
     ((COMMENT "(***Foo***)" "\\hbox{\\tt(***}\\hbox{Foo}\\hbox{\\tt***)}"))
     ((COMMENT "(****Foo****)" "\\hbox{\\tt(****}\\hbox{Foo}\\hbox{\\tt****)}"))
...
(defun test-group-fortress-intraline-idioms ()
  (test-fortress-test-group-funcall
   ...
   '(
     ...
     ;; Fractions
     ((EXTRA "" "{\\textstyle") (IDENTIFIER "a" "a") (OPERATOR "/" "\\over\\textstyle") (IDENTIFIER "b" "b") (EXTRA "" "}"))
     ((NUMBER "1" "1") (OPERATOR "+" "+") (EXTRA "" "{\\textstyle") (IDENTIFIER "a" "a") (OPERATOR "/" "\\over\\textstyle") (IDENTIFIER "b" "b") (EXTRA "" "}") (OPERATOR "+""+") (NUMBER "2" "2"))
     ((EXTRA "" "{\\textstyle") (LEFT-PARENTHESIS "(" "") (NUMBER "1" "1") (OPERATOR "+" "+") (IDENTIFIER "a" "a") (RIGHT-PARENTHESIS ")" "") (OPERATOR "/" "\\over\\textstyle")
      (LEFT-PARENTHESIS "(" "") (IDENTIFIER "b" "b") (OPERATOR "+""+") (NUMBER "2" "2") (RIGHT-PARENTHESIS ")" "") (EXTRA "" "}"))
     ((EXTRA "" "{\\textstyle")  (IDENTIFIER "a" "a") (OPERATOR "/" "\\over\\textstyle")
      (LEFT-PARENTHESIS "(" "") (IDENTIFIER "b" "b") (OPERATOR "+""+") (NUMBER "2" "2") (RIGHT-PARENTHESIS ")" "") (EXTRA "" "}"))
     ((EXTRA "" "{\\textstyle") (LEFT-PARENTHESIS "(" "") (NUMBER "1" "1") (OPERATOR "+" "+") (IDENTIFIER "a" "a") (RIGHT-PARENTHESIS ")" "") (OPERATOR "/" "\\over\\textstyle")
      (IDENTIFIER "b" "b") (EXTRA "" "}"))
     )))
...
(defun test-group-fortress-render-multiline-comment ()
  ...
  (test-fortress-test-group-funcall
   ...
   '(((COMMENT-START "(* Foo " "\\FortressBeginFlushLeftComment \\lind{0} Foo")
      (NEWLINE "\n" "\n") (COMMENT-MIDDLE "BAZOLA" "BAZOLA")
      (NEWLINE "\n" "\n") (COMMENT-END " {}#$'%''& *)" "\\{\\}\\#\\$'\\%{'}'\\& \\FortressEndComment"))
     ((COMMENT-START "(* \\ " "\\FortressBeginFlushLeftComment \\lind{0} {\\tt\\char'134}")
      (NEWLINE "\n" "\n") (COMMENT-MIDDLE " ^ " "{\\char'136}")
      (NEWLINE "\n" "\n") (COMMENT-END " ~ *)" " \\FortressEndComment"))
     ((COMMENT-START "(* _ " "\\FortressBeginFlushLeftComment \\lind{0} \\_")
      (NEWLINE "\n" "\n") (COMMENT-MIDDLE " \u222A " "\\(\\cup\\)")
      (NEWLINE "\n" "\n") (COMMENT-END " **Foo** *)" "{\\bf{Foo}} \\FortressEndComment"))
     ((COMMENT-START "(* //Foo// " "\\FortressBeginFlushLeftComment \\lind{0} \\emph{Foo}")
      (NEWLINE "\n" "\n") (COMMENT-MIDDLE " ##Foo## " "{\\tt{Foo}}")
      (NEWLINE "\n" "\n") (COMMENT-END " \"Foo\" *)" "{``}Foo{''} \\FortressEndComment"))
     ((COMMENT-START "(* ##\"Foo\"## " "\\FortressBeginFlushLeftComment \\lind{0} {\\tt{{\\char'42}Foo{\\char'42}}}")
      (NEWLINE "\n" "\n") (COMMENT-MIDDLE " **//Foo//** " "*\\emph{Foo}*")
      (NEWLINE "\n" "\n") (COMMENT-END " //**Foo**// *)" "\\emph{{\\bf\\emph{Foo}}} \\leftrightrule\\FortressEndComment"))
     ((COMMENT-START "(* **Foo //is// phoo** " "\\FortressBeginFlushLeftComment \\lind{0} {\\bf{Foo {\\bf\\emph{is}} phoo}}")
     ...
     ((COMMENT-START "(****Foo" "\\FortressTaggedBeginFlushLeftComment{***Foo}") (NEWLINE "\n" "\n")
      (COMMENT-MIDDLE " Foo " "\\lind{0} Foo") (NEWLINE "\n" "\n")
      (COMMENT-END " **Foo** ***)" "{\\bf{Foo}}  \\FortressTaggedEndComment{**}"))
     ;; Test tables
...
(defun test-group-fortress-intertoken ()
  (test-fortress-test-group-funcall
   ...
   '(((STRING "\"abc\"" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}``\\STR{abc}''}" "\\fortresscommentsep") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}" "\\fortresscommentsep") (STRING "\"ghi\"" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}``\\STR{ghi}''}"))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}" "\\fortresscommentsep") (NUMBER "456" "456") (OPERATOR "+" "+"))
     ((STRING-START "\"Str" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}``\\STR{Str}}") (NEWLINE "\n" " \\\\\n") (STRING-END "ing\"" "\\hbox{\\rm\\STR{ing}''}" "\\;") (NUMBER "456" "456") (WHITESPACE " " " ") (OPERATOR "+" "+"))
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}" "\\fortresscommentsep") (WHITESPACE " " " ") (CHARACTER-LITERAL "'R'" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}`\\STR{R}'}") (AMPERSAND "&" "\\OPR{{\\char'46}}"))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (DOT "." ".") (LEFT-BRACKET "[" "["))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (UNKNOWN "`" "\\underline{{\\char'140}}") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (RIGHT-PARENTHESIS ")" ")"))
     ((NUMBER "123" "123") (DOT "." ".") (SEMICOLON ";" ";"))
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}" "\\fortresscommentsep") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (COLON ":" "\\COLONOP"))
     ((COMMENT-START "(* Two-line" "") (NEWLINE "\n" " \\\\\n") (COMMENT-END "comment *)" "") (NEWLINE "\n" " \\\\\n") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (COMMA "," ","))
     ((UNKNOWN "`" "\\underline{{\\char'140}}" "\\fortresscommentsep") (WHITESPACE " " " ") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (COMMA "," ","))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (AMPERSAND "&" "\\OPR{{\\char'46}}") (NEWLINE "\n" " \\\\\n") (LEFT-BRACKET "[" "["))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (KEYWORD "else" "\\KWD{else}") (LEFT-ENCLOSER "<|" "\\langle"))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (OPERATOR "<" "<") (WHITESPACE " " " ") (COMMA "," ","))
     ((STRING "\"abc\"" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}``\\STR{abc}''}") (WHITESPACE " " " ") (OPERATOR ">" ">") (SEMICOLON ";" ";"))
     ((NUMBER "123" "123") (WHITESPACE " " " ") (OPERATOR "<" "<") (NEWLINE "\n" " \\\\\n") (COMMA "," ","))
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (LEFT-ENCLOSER "{" "\\lbrace") (UNKNOWN "`" "\\underline{{\\char'140}}"))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (LEFT-BRACKET "[" "[") (OPERATOR "<" "<"))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (LEFT-BRACKET "[" "[") (NEWLINE "\n" " \\\\\n") (RIGHT-BRACKET "]" "]"))
     ((UNKNOWN "`" "\\underline{{\\char'140}}") (NEWLINE "\n" " \\\\\n") (LEFT-ENCLOSER "{" "\\lbrace" "\\ultrathin") (RIGHT-ENCLOSER "}" "\\rbrace"))
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (WHITESPACE " " " ") (LEFT-PARENTHESIS "(" "(") (NEWLINE "\n" " \\\\\n") (RIGHT-PARENTHESIS ")" ")"))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (WHITESPACE " " " ") (LEFT-BRACKET "[" "[") (SEMICOLON ";" ";"))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (RIGHT-ENCLOSER "}" "\\rbrace") (OPERATOR "<" "<"))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (RIGHT-ENCLOSER "|>" "\\rangle") (NEWLINE "\n" " \\\\\n") (RIGHT-ENCLOSER "}" "\\rbrace"))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (COMMA "," ",") (WHITESPACE " " " ") (NUMBER "789" "789"))
     ...
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (COMMA "," ",") (WHITESPACE " " " ") (KEYWORD "else" "\\KWD{else}"))
     ((IDENTIFIER "x" "x") (WHITESPACE " " " ") (COMMA "," ",") (OPERATOR ">" ">"))
     ((COMMENT "(* Foo *)" "\\hbox{\\tt(*}\\hbox{ Foo }\\hbox{\\tt*)}") (WHITESPACE " " " ") (COMMA "," ",") (NEWLINE "\n" " \\\\\n") (OPERATOR "<" "<"))
     ...
     ((AMPERSAND "&" "\\OPR{{\\char'46}}") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (OPERATOR "+" "+"))
     ...
     ((OPERATOR "+" "+") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (LEFT-ENCLOSER "<|" "\\langle"))
     ...
     ((OPERATOR "+" "+") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (RIGHT-ENCLOSER "|>" "\\rangle"))
     ((AMPERSAND "&" "\\OPR{{\\char'46}}") (NEWLINE "\n" " \\\\\n") (NUMBER "456" "456") (NEWLINE "\n" " \\\\\n") (RIGHT-PARENTHESIS ")" ")"))
     ((AMPERSAND "&" "\\OPR{{\\char'46}}") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (COLON ":" "\\COLONOP"))
     ((AMPERSAND "&" "\\OPR{{\\char'46}}") (CHARACTER-LITERAL "'R'" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}`\\STR{R}'}") (NEWLINE "\n" " \\\\\n") (COLON ":" "\\COLONOP"))
     ((AMPERSAND "&" "\\OPR{{\\char'46}}") (NEWLINE "\n" " \\\\\n") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (COLON ":" "\\COLONOP"))
     ...
     ((AMPERSAND "&" "\\OPR{{\\char'46}}") (RIGHT-BRACKET "]" "]") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ...
     ((OPERATOR ">" ">") (IDENTIFIER "y" "y" "\\fortresscommentsep") (WHITESPACE " " " ") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ((OPERATOR "<" "<") (WHITESPACE " " " ") (IDENTIFIER "y" "y" "\\fortresscommentsep") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ...
     ((OPERATOR "<" "<") (WHITESPACE " " " ") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (OPERATOR "<" "<"))
     ((KEYWORD "else" "\\KWD{else}") (WHITESPACE " " " ") (IDENTIFIER "y" "y") (NEWLINE "\n" " \\\\\n") (KEYWORD "else" "\\KWD{else}"))
     ((KEYWORD "else" "\\KWD{else}") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (LEFT-PARENTHESIS "(" "("))
     ...
     ((KEYWORD "else" "\\KWD{else}") (WHITESPACE " " " ") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (NEWLINE "\n" " \\\\\n") (LEFT-BRACKET "[" "["))
     ...
     ((OPERATOR "<" "<") (WHITESPACE " " " ") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (WHITESPACE " " "\\,") (RIGHT-BRACKET "]" "]"))
     ...
     ((LEFT-ENCLOSER "<|" "\\langle") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (OPERATOR "+" "+"))
     ((LEFT-BRACKET "[" "[") (NEWLINE "\n" " \\\\\n") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (NEWLINE "\n" " \\\\\n") (OPERATOR "+" "+"))
     ...
     ((LEFT-ENCLOSER "<|" "\\langle") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (RIGHT-ENCLOSER "}" "\\rbrace"))
     ...
     ((LEFT-PARENTHESIS "(" "(") (WHITESPACE " " "\\,") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (COLON ":" "\\COLONOP"))
     ...
     ((LEFT-ENCLOSER "<|" "\\langle" "\\ultrathin") (RIGHT-ENCLOSER "}" "\\rbrace") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ((LEFT-BRACKET "[" "[" "\\ultrathin") (RIGHT-PARENTHESIS ")" ")") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ...
     ((RIGHT-ENCLOSER "}" "\\rbrace") (CHARACTER-LITERAL "'R'" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}`\\STR{R}'}" "\\fortresscommentsep") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ((RIGHT-ENCLOSER "|>" "\\rangle") (CHARACTER-LITERAL "'R'" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}`\\STR{R}'}" "\\fortresscommentsep") (WHITESPACE " " " ") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ((RIGHT-PARENTHESIS ")" ")") (NEWLINE "\n" " \\\\\n") (UNKNOWN "`" "\\underline{{\\char'140}}" "\\fortresscommentsep") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ...
     ((RIGHT-ENCLOSER "|>" "\\rangle") (NEWLINE "\n" " \\\\\n") (IDENTIFIER "y" "y") (WHITESPACE " " " ") (OPERATOR "+" "+"))
     ((RIGHT-PARENTHESIS ")" ")") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (OPERATOR ">" ">"))
     ((RIGHT-BRACKET "]" "]") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (WHITESPACE " " " ") (KEYWORD "else" "\\KWD{else}"))
     ...
     ((RIGHT-ENCLOSER "|>" "\\rangle") (WHITESPACE " " " ") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (RIGHT-ENCLOSER "}" "\\rbrace"))
     ((RIGHT-PARENTHESIS ")" ")") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (UNKNOWN "`" "\\underline{{\\char'140}}") (WHITESPACE " " "\\,") (RIGHT-BRACKET "]" "]"))
     ((RIGHT-ENCLOSER "|>" "\\rangle") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (SEMICOLON ";" ";"))
     ((RIGHT-ENCLOSER "}" "\\rbrace") (CHARACTER-LITERAL "'R'" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}`\\STR{R}'}") (WHITESPACE " " " ") (COLON ":" "\\COLONOP"))
     ((RIGHT-PARENTHESIS ")" ")") (WHITESPACE " " " ") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (COLON ":" "\\COLONOP"))
     ...
     ((RIGHT-BRACKET "]" "]") (KEYWORD "else" "\\KWD{else}") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ...
     ((RIGHT-ENCLOSER "|>" "\\rangle") (LEFT-ENCLOSER "{" "\\lbrace") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ((RIGHT-PARENTHESIS ")" ")") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (LEFT-ENCLOSER "{" "\\lbrace") (STRING "\"ghi\"" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}``\\STR{ghi}''}"))
     ((RIGHT-BRACKET "]" "]") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (LEFT-ENCLOSER "<|" "\\langle") (WHITESPACE " " "\\,") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ...
     ((COLON ":" "\\COLONOP") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}" "\\fortresscommentsep") (UNKNOWN "`" "\\underline{{\\char'140}}"))
     ((SEMICOLON ";" ";") (CHARACTER-LITERAL "'R'" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}`\\STR{R}'}") (NEWLINE "\n" " \\\\\n") (UNKNOWN "`" "\\underline{{\\char'140}}"))
     ((SEMICOLON ";" ";") (WHITESPACE " " " ") (CHARACTER-LITERAL "'R'" "\\hbox{\\rm\\usefont{T1}{ptm}{m}{n}`\\STR{R}'}" "\\fortresscommentsep") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
     ...
     ((SEMICOLON ";" ";") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (KEYWORD "else" "\\KWD{else}"))
     ...
     ((COMMA "," ",") (NEWLINE "\n" " \\\\\n") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (DIGIT-GROUP-SEPARATOR "\u202F" "\\,") (OPERATOR ">" ">"))
     ((COLON ":" "\\COLONOP") (NUMBER "456" "456") (LEFT-ENCLOSER "{" "\\lbrace"))
     ((COLON ":" "\\COLONOP") (COMMENT "(* Bar *)" "\\hbox{\\tt(*}\\hbox{ Bar }\\hbox{\\tt*)}") (WHITESPACE " " " ") (LEFT-BRACKET "[" "["))
     ...
     ((COLON ":" "\\COLONOP") (WHITESPACE " " " ") (KEYWORD "else" "\\KWD{else}") (COMMENT "(* Baz *)" "\\hbox{\\tt(*}\\hbox{ Baz }\\hbox{\\tt*)}"))
