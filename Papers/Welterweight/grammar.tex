...
\infax[S-Any]
  { \jsubtype{\kappa}{\TYP{Any}} }

\bigskip

\infax[S-Bottom]
  { \jsubtype{\TYP{Bottom}}{\kappa} }

\bigskip

\infax[S-Object]
  { \jsubtype{c}{\TYP{Object}} }
...
\infrule[E-Tuple-Bottom]
  { \kappa' \in \setb{\kappa}  \andalso  \jsubtype{\kappa'}{\TYP{Bottom}} }
  { \jequivtype{(\bar{\kappa})}{\TYP{Bottom}} }
...
\infrule[U-Absorption]   % From this and properties of \TYP{Any} and \TYP{Bottom} we have identity, zero, and idempotence
  { \jsubtype{\alpha}{\eta} }
...
\infrule[I-Absorption]   % From this and properties of \TYP{Any} and \TYP{Bottom} we have identity, zero, and idempotence
  { \jsubtype{\alpha}{\eta} }
