...
\newjudge{Exclusion Rules That Generate Constraints}{\jexc{\alpha}{\alpha}{\C}}
\vspace*{1em}
...
\infrule
  { \countof(\bar{\alpha})=\countof(\bar{\eta})  \andalso \jbexc{\alpha}{T}{\C} }
...
\infrule
  { \mathit{distinct}(T,T')  \andalso  \setb{\chi} = \ancestors(T\obb{\alpha}) \\[1pt]
    \setb{\omega} = \bigcup\setb{\myexcludes{\chi}}  \andalso  \jbsub{\underline{T'\obb{\eta}}}{\omega}{\C} }
  { \jgconstrtemplate{T\obb{\alpha}}{\excrx}{T'\obb{\eta}}{\bigvee\bigsetb{\C}} }

\infrule
  { \mathit{distinct}(T,T')  \\
    \setb{\omega} = \bigcup\setb{\mycomprises{T\obb{\alpha}}}  \andalso  \jbexc{\underline{T'\obb{\eta}}}{\omega}{\C}
}
  { \jgconstrtemplate{T\obb{\alpha}}{\excrc}{T'\obb{\eta}}{\bigwedge\bigsetb{\C}} }

% \infrule
%   {C \neq D \andalso \text{$C$ does not have a \KWD{comprises} clause}}
...
\infrule
  { \setb{\chi} = \ancestors(T\obb{\alpha}) \andalso
    \setb{\omega} = \ancestors(T'\obb{\eta}) \\[3pt]
    \jgbbconstrtemplate{\chi}{\bexcm}{\underline{\omega}}{\C} }
