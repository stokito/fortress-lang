...
\infrule
  { \mathit{distinct}(T,T')  \andalso  \setb{\chi} = \ancestors{T\obb{\alpha}} \\[1pt]
    \setb{\omega} = \bigcup\setb{\excluded[\underline{\Delta}]{\chi}}  \andalso  \jbsub{\underline{T'\obb{\eta}}}{\omega}{\C} }
  { \jgconstrtemplate{T\obb{\alpha}}{\excrx}{T'\obb{\eta}}{\bigvee\bigsetb{\C}} }

\infrule
  { \mathit{distinct}(T,T')  \\
    \setb{\omega} = \comprised{T\obb{\alpha}}  \andalso  \jbexc{\underline{T'\obb{\eta}}}{\omega}{\C}
}
