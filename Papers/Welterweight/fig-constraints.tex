...
\newjudge{Convert type environment to constraints}{\toConstraint{\Delta}{\C}}
\medskip
\newjudge{Convert constraints to type environment}{\toBounds{\C}{\Delta}}
\medskip
\newjudge{Solve constraints}{\jsolve{\C}{\phi}{\C}}
