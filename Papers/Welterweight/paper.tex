...
\newcommand{\dontcare}{\vbox to 0pt{\vss\hrule width 1ex}}
...
\newcommand{\ancestors}[2][\Delta]{\textit{ancestors}(#1,#2)}
...
\newcommand{\newjudge}[2]{\hbox{\textbf{#1:} \quad \fbox{\ensuremath{#2}}}}
...
\newcommand{\jwfmeth}[2][\Delta;\Gamma;\bar{P};\bar{z}]{\jgshorttemplate[#1]{#2}{\mathsf{ok}}}
\newcommand{\jbwfmeth}[2][\Delta;\Gamma;\bar{P};\bar{z}]{\jgbshorttemplate[#1]{#2}{\mathsf{ok}}}
