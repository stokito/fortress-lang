...
\infrule[R-Method]
  { \kwd{object} \; O\ob{\dontcare}(\bar{z:\dontcare}) \; \dontcare \; \kwd{end} \in \Delta \\[2pt]
  ...
  { \jevalstep[\Delta]{E\big[O\obb{\gamma}(\bar{v}).m(\bar{v'})\big]}{E\big[ [O\obb{\gamma}(\bar{v})/\kwd{self}][\bar{\kwd{self}.z/z}][\bar{v'/x}][\bar{\tau/P}]e \big]} }
