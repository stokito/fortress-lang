...
\item \verb+AbstractArrow+\LOBR\verb+S;V+\ROBR\ includes an apply method that takes Java Objects and returns a Java Object.  Within that apply method, are the necessary casts.  {\it Question: will tuples of objects be an issue? }
