...
opr BIG UNIONCAT[\T extends StandardTotalOrder[\T\],U\](): BigReduction[\Map[\T, List[\U\]\],Map[\T, List[\U\]\]\]
opr UNIONPLUS[\T extends StandardTotalOrder[\T\]\](a: Map[\T, ZZ32\], b: Map[\T, ZZ32\]): Map[\T, ZZ32\] 
opr BIG UNIONPLUS[\T extends StandardTotalOrder[\T\]\](): BigReduction[\Map[\T, ZZ32\],Map[\T, ZZ32\]\]
