...
/** Run desugaring phases that must occur after disambiguation and before type checking.
 *  1) Desugar compound/tuple assignments (this requires identifying subexpressions of LHS)
 *  2) Desugar subscripting expressions to method calls.
 *  3) Desugar subscripting assignments
 */
