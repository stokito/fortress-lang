...
public class DirectedRounding {
  ...
  public static float nextDown(float x) { return -nextUp(-x); }
  ...
  public static float subtractUp(float x, float y) { return addUp(x, -y); }
  ...
  public static float addDown(float x, float y) { return -addUp(-x, -y); }

  public static float subtractDown(float x, float y) { return -subtractUp(y, x); }

  public static float multiplyDown(float x, float y) { return -multiplyUp(-x, y); }

  public static float divideDown(float x, float y) { return -divideUp(-x, y); }
  ...
  public static double nextDown(double x) { return -nextUp(-x); }
  ...
  public static double subtractUp(double x, double y) { return addUp(x, -y); }
  ...
  public static double multiplyUp(double x, double y) {
    ...
    // x and z are denormalized, so scale x and z by 2**60
            xs = x * double_2_pow_60; a = Double.doubleToRawLongBits(xs);
            zs = z * double_2_pow_60; c = Double.doubleToRawLongBits(zs);
          } else {
            // Only x is denormalized, so y > 1; we can scale x up and y down
            xs = x * double_2_pow_60; a = Double.doubleToRawLongBits(xs);
            ys = y / double_2_pow_60; b = Double.doubleToRawLongBits(ys);
          }
        } else {
          if (((b << 1) >>> 53) == 0) {
            if (((c << 1) >>> 53) == 0) {
  ...
  public static double addDown(double x, double y) { return -addUp(-x, -y); }

  public static double subtractDown(double x, double y) { return -subtractUp(y, x); }

  public static double multiplyDown(double x, double y) { return -multiplyUp(-x, y); }

  public static double divideDown(double x, double y) { return -divideUp(-x, y); }
