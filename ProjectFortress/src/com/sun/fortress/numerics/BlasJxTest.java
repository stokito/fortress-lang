...
public class BlasJxTest extends TestCase {
    ...
    public void testVectorMatrixMultiply1(){
        ...
        double[] result = Blas.vectorMatrixMultiply( Blas.Order.RowMajor, Blas.Transpose.NoTranspose, 3, 4, 1.0, matrix, 4, 0, vector, 1, 0 );
    ...
    public void testMatrixMatrixMultiply1(){
        ...
        double[] m1 = new double[]{ 4,  0, 0, 14, 
                                    ...
                                    0,  0,25, 65,
                                   14, 33,65,339, };
        double[] result = Blas.matrixMatrixMultiply( Blas.Order.RowMajor, Blas.Transpose.Transpose, Blas.Transpose.NoTranspose, 4, 4, 3, 1.0, m0, 4, 0, m0, 4, 0 );
