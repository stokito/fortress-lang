...
class HygienicRenamer(constituent: APIName,
  ...
  def replaceAtUse(name: IdOrOpOrAnonymousName) = {
    ...
    override def walk(node: Any): Any = node match {
         ...
         case SFnRef(getInfo, getStaticArgs, getLexicalDepth, getOriginalName, getNames, getInterpOverloadings, getNewOverloadings, getOverloadingType) =>
             SFnRef(walk(getInfo).asInstanceOf[com.sun.fortress.nodes.ExprInfo], walk(getStaticArgs).asInstanceOf[List[com.sun.fortress.nodes.StaticArg]], walk(getLexicalDepth).asInstanceOf[Int], walk(getOriginalName).asInstanceOf[com.sun.fortress.nodes.IdOrOp], walk(getNames).asInstanceOf[List[com.sun.fortress.nodes.IdOrOp]], walk(getInterpOverloadings).asInstanceOf[List[com.sun.fortress.nodes.Overloading]], walk(getNewOverloadings).asInstanceOf[List[com.sun.fortress.nodes.Overloading]], walk(getOverloadingType).asInstanceOf[Option[com.sun.fortress.nodes.Type]])
         ...
         case SObjectDecl(getInfo, getHeader, getParams, getSelfType) =>
             SObjectDecl(walk(getInfo).asInstanceOf[com.sun.fortress.nodes.ASTNodeInfo], walk(getHeader).asInstanceOf[com.sun.fortress.nodes.TraitTypeHeader], walk(getSelfType).asInstanceOf[Option[com.sun.fortress.nodes.Type]], walk(getParams).asInstanceOf[Option[List[com.sun.fortress.nodes.Param]]])
         case SObjectExpr(getInfo, getHeader, getSelfType) =>
             SObjectExpr(walk(getInfo).asInstanceOf[com.sun.fortress.nodes.ExprInfo], walk(getHeader).asInstanceOf[com.sun.fortress.nodes.TraitTypeHeader], walk(getSelfType).asInstanceOf[Option[com.sun.fortress.nodes.Type]])
         ...
         case SOpArg(getInfo, isLifted, getName) =>
             SOpArg(walk(getInfo).asInstanceOf[com.sun.fortress.nodes.ASTNodeInfo], walk(isLifted).asInstanceOf[Boolean], walk(getName).asInstanceOf[com.sun.fortress.nodes.FunctionalRef])
         ...
         case SOpRef(getInfo, getStaticArgs, getLexicalDepth, getOriginalName, getNames, getInterpOverloadings, getNewOverloadings, getOverloadingType) =>
         ...
         case SOverloading(getInfo, getUnambiguousName, getOriginalName, getType) =>
             SOverloading(walk(getInfo).asInstanceOf[com.sun.fortress.nodes.ASTNodeInfo], walk(getUnambiguousName).asInstanceOf[com.sun.fortress.nodes.IdOrOp], walk(getOriginalName).asInstanceOf[com.sun.fortress.nodes.IdOrOp], walk(getType).asInstanceOf[Option[com.sun.fortress.nodes.ArrowType]])
