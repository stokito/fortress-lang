...
class HygienicRenamer(constituent: APIName,
  ...
  def replaceAtUse(name: IdOrOpOrAnonymousName) = {
    ...
    override def walk(node: Any): Any = node match {
         ...
         case SFnRef(getInfo, getStaticArgs, getLexicalDepth, getOriginalName, getNames, getOverloadings, getNewOverloadings, getOverloadingType) =>
             SFnRef(walk(getInfo).asInstanceOf[com.sun.fortress.nodes.ExprInfo], walk(getStaticArgs).asInstanceOf[List[com.sun.fortress.nodes.StaticArg]], walk(getLexicalDepth).asInstanceOf[Int], walk(getOriginalName).asInstanceOf[com.sun.fortress.nodes.IdOrOp], walk(getNames).asInstanceOf[List[com.sun.fortress.nodes.IdOrOp]], walk(getOverloadings).asInstanceOf[Option[List[com.sun.fortress.nodes.FunctionalRef]]], walk(getNewOverloadings).asInstanceOf[List[com.sun.fortress.nodes.Overloading]], walk(getOverloadingType).asInstanceOf[Option[com.sun.fortress.nodes.Type]])
         ...
         case SObjectDecl(getInfo, getHeader, getParams, getSelfType) =>
             SObjectDecl(walk(getInfo).asInstanceOf[com.sun.fortress.nodes.ASTNodeInfo], walk(getHeader).asInstanceOf[com.sun.fortress.nodes.TraitTypeHeader], walk(getParams).asInstanceOf[Option[List[com.sun.fortress.nodes.Param]]], walk(getSelfType).asInstanceOf[Option[com.sun.fortress.nodes.Type]])
         ...
         case SOpRef(getInfo, getStaticArgs, getLexicalDepth, getOriginalName, getNames, getOverloadings, getNewOverloadings, getOverloadingType) =>
         ...
         case STraitDecl(getInfo, getHeader, getExcludesClause, getComprisesClause, isComprisesEllipses, getSelfType) =>
             STraitDecl(walk(getInfo).asInstanceOf[com.sun.fortress.nodes.ASTNodeInfo], walk(getHeader).asInstanceOf[com.sun.fortress.nodes.TraitTypeHeader], walk(getExcludesClause).asInstanceOf[List[com.sun.fortress.nodes.BaseType]], walk(getComprisesClause).asInstanceOf[Option[List[com.sun.fortress.nodes.BaseType]]], walk(isComprisesEllipses).asInstanceOf[Boolean], walk(getSelfType).asInstanceOf[Option[com.sun.fortress.nodes.Type]])
