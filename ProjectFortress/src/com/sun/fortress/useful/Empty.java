...
public class Empty<T> extends PureList<T> {
   ...
   public <U> PureList<U> map(Fn<T,U> fn) { return new Empty<U>(); }
   public boolean contains(T candidate) { return false; }
   public PureList<T> cons(T elt) { return new Cons<T>(elt, this); }
   public PureList<T> append(PureList<T> that) { return that; }
   public PureList<T> reverse(PureList<T> result) { return result; }
