...
public final class TrieMap<V> extends AbstractMap<String,V>
    ...
    public TrieMap(String key, V value) {
        if (key==null)
            throw new NullPointerException("TrieMap doesn't support null keys");
    ...
    private final class TriePath implements Iterator<Map.Entry<String,V>> {
        ...
        TrieNode<V> trieNodeL(int ch, Trie<V> l, Trie<V> e, Trie<V> g) {
            if (l instanceof TrieNode) {
                ...
                if (lwt > 2 * gwt) {
                    return new TrieNode<V>(n.ch, n.less, n.equal,
                                           new TrieNode<V>(ch,n.greater,e,g));
                }
            }
        ...
        TrieNode<V> trieNodeG(int ch, Trie<V> l, Trie<V> e, Trie<V> g) {
            if (g instanceof TrieNode) {
                ...
                if (gwt > 2 * lwt) {
                    return new TrieNode<V>(n.ch, new TrieNode<V>(ch,l,e,n.less),
                                           n.equal, n.greater);
                }
            }
            return new TrieNode<V>(ch,l,e,g);
    ...
    private final static class TrieNode<V> extends Trie<V>
    ...
    private final static class TrieLeaf<V> extends Trie<V>
        implements Map.Entry<String,V>, java.io.Serializable {
        final String key;
        final V value;
        ...
        public boolean equals(Object that) {
            if (!(that instanceof TrieLeaf)) { return false; }
