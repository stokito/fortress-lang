...
public class AbsTypeAlias extends WhereClause implements AbsDecl {
  private final Id _name;
  private final List<StaticParam> _staticParams;

  /**
   * Constructs a AbsTypeAlias.
   * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
   */
  public AbsTypeAlias(Span in_span, Id in_name, List<StaticParam> in_staticParams) {
    super(in_span);

    if (in_name == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'name' to the AbsTypeAlias constructor was null");
    }
    _name = in_name;

    if (in_staticParams == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'staticParams' to the AbsTypeAlias constructor was null");
    }
  ...
  public <RetType> RetType visit(NodeVisitor<RetType> visitor) { return visitor.forAbsTypeAlias(this); }
  public void visit(NodeVisitor_void visitor) { visitor.forAbsTypeAlias(this); }
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
      ...
      AbsTypeAlias casted = (AbsTypeAlias) obj;
      Id temp_name = getName();
