...
public class Opr extends OprName {
   ...
   */
  public Opr(Span in_span, Op in_op) {
    super(in_span);

    if (in_op == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'op' to the Opr constructor was null");
    }
    _op = in_op;
  }
  ...
  public void visit(NodeVisitor_void visitor) { visitor.forOpr(this); }
