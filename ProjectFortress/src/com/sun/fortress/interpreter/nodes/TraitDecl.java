...
public class TraitDecl extends TraitDefOrDecl implements GenericDef {
   ...
   */
  public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, Option<List<StaticParam>> in_staticParams, Option<List<TypeRef>> in_extendsClause, List<TypeRef> in_excludes, Option<List<TypeRef>> in_bounds, List<WhereClause> in_where, List<? extends DefOrDecl> in_fns) {
    super(in_span, in_mods, in_name, in_staticParams, in_extendsClause, in_excludes, in_bounds, in_where);

    if (in_fns == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'fns' to the TraitDecl constructor was null");
    }
    _fns = in_fns;
  }
  ...
  public <RetType> RetType visit(NodeVisitor<RetType> visitor) { return visitor.forTraitDecl(this); }
  public void visit(NodeVisitor_void visitor) { visitor.forTraitDecl(this); }
