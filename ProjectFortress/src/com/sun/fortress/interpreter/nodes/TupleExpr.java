...
public class TupleExpr extends DelimitedExpr {
  ...
  public <RetType> RetType visit(NodeVisitor<RetType> visitor) { return visitor.forTupleExpr(this); }
  public void visit(NodeVisitor_void visitor) { visitor.forTupleExpr(this); }
