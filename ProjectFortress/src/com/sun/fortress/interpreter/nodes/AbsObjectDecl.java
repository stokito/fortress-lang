...
public class AbsObjectDecl extends ObjectDefOrDecl implements GenericDefWithParams {
   ...
   */
  public AbsObjectDecl(Span in_span, List<Modifier> in_mods, Id in_name, Option<List<StaticParam>> in_staticParams, Option<List<Param>> in_params, Option<List<TypeRef>> in_traits, List<TypeRef> in_throwsClause, List<WhereClause> in_where, Contract in_contract, List<? extends DefOrDecl> in_defOrDecls) {
    ...
    if (in_defOrDecls == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'defOrDecls' to the AbsObjectDecl constructor was null");
    }
  ...
  public <RetType> RetType visit(NodeVisitor<RetType> visitor) { return visitor.forAbsObjectDecl(this); }
  public void visit(NodeVisitor_void visitor) { visitor.forAbsObjectDecl(this); }
