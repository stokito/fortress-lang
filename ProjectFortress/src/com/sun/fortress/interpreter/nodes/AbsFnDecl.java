...
public class AbsFnDecl extends FnDefOrDecl implements Decl, AbsDecl, Applicable {
   ...
   */
  public AbsFnDecl(Span in_span, List<Modifier> in_mods, FnName in_fnName, Option<List<StaticParam>> in_staticParams, List<Param> in_params, Option<TypeRef> in_returnType, List<TypeRef> in_throwsClause, List<WhereClause> in_where, Contract in_contract, String in_selfName) {
    super(in_span, in_mods, in_fnName, in_staticParams, in_params, in_returnType, in_throwsClause, in_where, in_contract);

    if (in_selfName == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'selfName' to the AbsFnDecl constructor was null");
    }
  ...
  public <RetType> RetType visit(NodeVisitor<RetType> visitor) { return visitor.forAbsFnDecl(this); }
  public void visit(NodeVisitor_void visitor) { visitor.forAbsFnDecl(this); }
