...
public class IfClause extends AbstractNode {
   ...
   */
  public IfClause(Span in_span, Expr in_test, Expr in_body) {
    super(in_span);

    if (in_test == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'test' to the IfClause constructor was null. This class may not have null field values.");
    }
    _test = in_test;

    if (in_body == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'body' to the IfClause constructor was null. This class may not have null field values.");
    }
    _body = in_body;
  }
  ...
  public <RetType> RetType visit(NodeVisitor<RetType> visitor) { return visitor.forIfClause(this); }
  public void visit(NodeVisitor_void visitor) { visitor.forIfClause(this); }
