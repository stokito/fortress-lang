...
public class ExternalSyntax extends AbstractNode implements Decl, AbsDecl {
   ...
   */
  public ExternalSyntax(Span in_span, Name in_openExpander, Id in_id, Name in_closeExpander, Expr in_expr) {
    super(in_span);

    if (in_openExpander == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'openExpander' to the ExternalSyntax constructor was null");
    }
    _openExpander = in_openExpander;

    if (in_id == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'id' to the ExternalSyntax constructor was null");
    }
    _id = in_id;

    if (in_closeExpander == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'closeExpander' to the ExternalSyntax constructor was null");
    }
  ...
  public <RetType> RetType visit(NodeVisitor<RetType> visitor) { return visitor.forExternalSyntax(this); }
  public void visit(NodeVisitor_void visitor) { visitor.forExternalSyntax(this); }
