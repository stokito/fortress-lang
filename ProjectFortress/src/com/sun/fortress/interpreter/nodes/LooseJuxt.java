...
public class LooseJuxt extends Primary {
  ...
  public LooseJuxt(Span in_span, List<Expr> in_exprs) {
    ...
    if (in_exprs == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'exprs' to the LooseJuxt constructor was null");
    }
    _exprs = in_exprs;
  }
  ...
  public <RetType> RetType visit(NodeVisitor<RetType> visitor) { return visitor.forLooseJuxt(this); }
  public void visit(NodeVisitor_void visitor) { visitor.forLooseJuxt(this); }
