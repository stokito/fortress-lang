...
public static final class Negate extends F2F {
    protected float f(float x) { return -x; }
}
public static final class Add extends FF2F {
    protected float f(float x, float y) { return x + y; }
}
...
public static final class Sqrt extends F2F {
    protected float f(float x) { return (float)Math.sqrt(x); }
}
public static final class AddUp extends FF2F {
    protected float f(float x, float y) { return DirectedRounding.addUp(x,y); }
}
public static final class SubUp extends FF2F {
    protected float f(float x, float y) { return DirectedRounding.subtractUp(x,y); }
}
public static final class MulUp extends FF2F {
    protected float f(float x, float y) { return DirectedRounding.multiplyUp(x,y); }
}
public static final class DivUp extends FF2F {
    protected float f(float x, float y) { return DirectedRounding.divideUp(x,y); }
}
public static final class SqrtUp extends F2F {
    protected float f(float x) { return DirectedRounding.sqrtUp(x); }
}
public static final class AddDown extends FF2F {
    protected float f(float x, float y) { return DirectedRounding.addDown(x,y); }
}
public static final class SubDown extends FF2F {
    protected float f(float x, float y) { return DirectedRounding.subtractDown(x,y);}
}
public static final class MulDown extends FF2F {
    protected float f(float x, float y) { return DirectedRounding.multiplyDown(x,y);}
}
public static final class DivDown extends FF2F {
    protected float f(float x, float y) { return DirectedRounding.divideDown(x,y); }
}
...
public static final class Min extends FF2F {
    protected float f(float x, float y) { return Math.min(x,y); }
}
public static final class Max extends FF2F {
    protected float f(float x, float y) { return Math.max(x,y); }
}
...
public static final class Ceiling extends F2F {
    protected float f(float x) { return (float)Math.ceil(x); }
}
public static final class Floor extends F2F {
    protected float f(float x) { return (float)Math.floor(x); }
}
public static final class ICeiling extends F2L {
    protected long f(float x) { return (long)Math.ceil(x); }
}
...
public static final class Abs extends F2F {
    protected float f(float x) { return Math.abs(x); }
}
public static final class NextUp extends F2F {
    protected float f(float x) { return DirectedRounding.nextUp(x); }
}
public static final class NextDown extends F2F {
    protected float f(float x) { return DirectedRounding.nextDown(x); }
}
public static final class RawBits extends F2I {
    protected int f(float x) { return java.lang.Float.floatToRawIntBits(x); }
}
public static final class FromRawBits extends Util.I2F {
    protected float f(int x) { return java.lang.Float.intBitsToFloat(x); }
}

public static final class Random extends Util.F2F {
    protected float f(float scale) { return (float)(scale*Math.random()); }
}

public static final class isInfinite extends F2B {
    protected boolean f(float x) { return java.lang.Float.isInfinite(x); }
}
