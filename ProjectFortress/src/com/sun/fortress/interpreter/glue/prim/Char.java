...
public class Char extends NativeConstructor {
    ...
    public static final class GetNumericValue extends s2I {
       protected int f(int x) { return Character.getNumericValue(x); }
    }

    /* Returns a value indicating a character's general category. */
    public static final class GetType extends s2I {
       protected int f(int x) { return Character.getType(x); }
    }

    /* Determines if a character (Unicode code point) is defined in Unicode. */
    public static final class IsDefined extends s2B {
       protected boolean f(int x) { return Character.isDefined(x); }
    }

    /* Determines if the specified character (Unicode code point) is a digit. */
    public static final class IsDigit extends s2B {
       protected boolean f(int x) { return Character.isDigit(x); }
    }
    ...
    public static final class IsFortressIdentifierStart extends s2B {
       protected boolean f(int x) { return Character.isLetter(x) || (x == (int)'_'); }
    }
    ...
    public static final class IsHighSurrogate extends s2B {
       protected boolean f(int x) { return (x <= 0xFFFF) && Character.isHighSurrogate((char) x); }
    }

    /* Determines if the specified character (Unicode code point) should be regarded as an ignorable character in a Java identifier or a Unicode identifier. */
    public static final class IsIdentifierIgnorable extends s2B {
       protected boolean f(int x) { return Character.isIdentifierIgnorable(x); }
    }
    ...
    public static final class IsISOControl extends s2B {
       protected boolean f(int x) { return Character.isISOControl(x); }
    }

    /* Determines if the character (Unicode code point) may be part of a Java identifier as other than the first character. */
    public static final class IsJavaIdentifierPart extends s2B {
       protected boolean f(int x) { return Character.isJavaIdentifierPart(x); }
    }

    /* Determines if the character (Unicode code point) is permissible as the first character in a Java identifier. */
    public static final class IsJavaIdentifierStart extends s2B {
       protected boolean f(int x) { return Character.isJavaIdentifierStart(x); }
    }

    /* Determines if the specified character (Unicode code point) is a letter. */
    public static final class IsLetter extends s2B {
       protected boolean f(int x) { return Character.isLetter(x); }
    }
    ...
    public static final class IsLowerCase extends s2B {
       protected boolean f(int x) { return Character.isLowerCase(x); }
    }
    ...
    public static final class IsLowSurrogate extends s2B {
       protected boolean f(int x) { return (x <= 0xFFFF) && Character.isLowSurrogate((char) x); }
    }
    ...
    public static final class IsMirrored extends s2B {
       protected boolean f(int x) { return Character.isMirrored(x); }
    }
    ...
    public static final class IsSpaceChar extends s2B {
       protected boolean f(int x) { return Character.isSpaceChar(x); }
    }

    /* Determines whether the specified character (Unicode code point) is in the supplementary character range. */
    public static final class IsSupplementaryCodePoint extends s2B {
       protected boolean f(int x) { return Character.isSupplementaryCodePoint(x); }
    }
    ...
    public static final class IsTitleCase extends s2B {
       protected boolean f(int x) { return Character.isTitleCase(x); }
    }
    ...
    public static final class IsUnicodeIdentifierPart extends s2B {
       protected boolean f(int x) { return Character.isUnicodeIdentifierPart(x); }
    }
    ...
    public static final class IsUnicodeIdentifierStart extends s2B {
       protected boolean f(int x) { return Character.isUnicodeIdentifierStart(x); }
    }

    /* Determines if the specified character (Unicode code point) is an uppercase character. */
    public static final class IsUpperCase extends s2B {
       protected boolean f(int x) { return Character.isUpperCase(x); }
    }
    ...
    public static final class IsValidCodePoint extends s2B {
       protected boolean f(int x) { return Character.isValidCodePoint(x); }
    }

    /* Determines if the specified character (Unicode code point) is white space according to Java. */
    public static final class IsWhitespace extends s2B {
       protected boolean f(int x) { return Character.isWhitespace(x); }
    }
    ...
    public static final class ToLowerCase extends s2C {
       protected int f(int x) { return Character.toLowerCase(x); }
    }
    ...
    public static final class ToTitleCase extends s2C {
       protected int f(int x) { return Character.toTitleCase(x); }
    }
