...
public class RewriteTransformerNames extends NodeUpdateVisitor {
    ...
    */
    ...
    @Override public Node forPreTransformerDefOnly(PreTransformerDef that) {
        ...
        // addTransformer( name );
        return new TransformerDef( name, that.getTransformer() );
    }
}
