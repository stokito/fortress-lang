...
import com.sun.fortress.syntaxabstractions.phases.ProductionTranslator.Result;
import com.sun.fortress.syntaxabstractions.rats.RatsUtil;
...
public class GrammarTranslator {
	...
	public static Result translate(Collection<com.sun.fortress.syntaxabstractions.intermediate.Module> modules) {
		...
		for (com.sun.fortress.syntaxabstractions.intermediate.Module module: modules) {
