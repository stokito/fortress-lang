...
public class Left extends Object implements OpExpr {
   ...
   public Left(Op in_op) {
      ...
      if (in_op == null) {
         throw new java.lang.IllegalArgumentException("Parameter 'op' to the Left constructor was null. This class may not have null field values.");
      }
      _op = in_op;
   }
   ...
   public <RetType> RetType accept(OpExprVisitor<RetType> visitor) { return visitor.forLeft(this); }
   public void accept(OpExprVisitor_void visitor) { visitor.forLeft(this); }
