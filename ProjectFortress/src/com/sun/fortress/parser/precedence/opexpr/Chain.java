...
public abstract class Chain extends Object implements InfixFrame {
   ...
   public Chain(PureList<ExprOpPair> in_links) {
      ...
      if (in_links == null) {
         throw new java.lang.IllegalArgumentException("Parameter 'links' to the Chain constructor was null. This class may not have null field values.");
      }
      _links = in_links;
   }

   public PureList<ExprOpPair> getLinks() { return _links; }
