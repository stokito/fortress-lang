...
public class TightChain extends Chain {
   ...
   public <RetType> RetType accept(InfixFrameVisitor<RetType> visitor) { return visitor.forTightChain(this); }
   public void accept(InfixFrameVisitor_void visitor) { visitor.forTightChain(this); }
