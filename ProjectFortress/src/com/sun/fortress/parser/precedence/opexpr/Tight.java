...
public class Tight extends NonChain {
   ...
   public <RetType> RetType accept(InfixFrameVisitor<RetType> visitor) { return visitor.forTight(this); }
   public void accept(InfixFrameVisitor_void visitor) { visitor.forTight(this); }
