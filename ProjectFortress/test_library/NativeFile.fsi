...
object ReadStream(filename:String) extends FileStream
    ...
    characters(n:ZZ32):FileGenerator[\String\]
    characters():FileGenerator[\String\]
    ...
    (** chunks returns chunks of characters found in the file, in the
        ...
        chunks at a time.
     **)
    chunks(n:ZZ32,m:ZZ32):FileGenerator[\String\]
    chunks(n:ZZ32):FileGenerator[\String\]
    chunks(): FileGenerator[\String\]
end
